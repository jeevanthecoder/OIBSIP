...
import com.example.adminservice.security.JwtAuthenticationEntryPoint;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf(csrf -> csrf.disable())
                ...
                .requestMatchers("/admin-auth/login-admin").permitAll()
                .requestMatchers("/admin-auth/create-admin").permitAll()
